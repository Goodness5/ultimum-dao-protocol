    ...
    return (
       <div>
        ...
        <div className="grid-cols-1 bg-[#111] p-[0.5cm] rounded-xl" style={{boxShadow:"2px 2px 2px 2px #333"}}>
         <div className='mb-[1cm] text-center font-[500]'>To become a member of the Ultimum DAO, first buy 2,000 ULT and stake 1,000 ULT to be able to mint the Ultimum NFT which gives you access to the DAO.</div>
         <form>
         ...
         {userETHBalance == 0 && (<div className='text-center my-[0.5cm] font-[500]'>You don't have enough ETH for gas fees! <span><img src="images/disappointment.png" width="20" className='ml-[0.2cm]' style={{display:"inline-block"}} /></span></div>)}
         {userULTBalance >= 1000 && (<div className='text-center my-[0.5cm] font-[500]'>You already have enough ULT to stake. Please proceed to mint NFT! <span><img src="images/happy.png" width="20" className='ml-[0.2cm]' style={{display:"inline-block"}} /></span></div>)}
         </form>
        </div>
        <div className="grid-cols-1 bg-[#005] p-[0.5cm] rounded-xl" style={{boxShadow:"2px 2px 2px 2px #333"}}>
         <div className='mb-[1cm] text-center font-[500]'>Approve and stake 1,000 ULT to mint Ultimum NFT. Only Ultimum NFT and at least 1,000 ULT holders can join DAO.</div>
         <form>
         <div className='p-[0.5cm] pb-[1cm] bg-[#eee] rounded-md'>
         ...
         {stakedTokenCapital < 1000  && (<div className='text-center my-[0.5cm] font-[500]'>You don't have enough staked ULT to mint NFT! <span><img src="images/disappointment.png" width="20" className='ml-[0.2cm]' style={{display:"inline-block"}} /></span></div>)}
         </form>
        </div>
        </div>
       </div>
