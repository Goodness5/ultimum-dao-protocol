...
const scrollTestnetRPC = new ethers.providers.JsonRpcProvider(
  "https://scroll-sepolia.chainstacklabs.com"
);

// DAO section settings
const daoContractABI = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "string", name: "_username", type: "string" },
      { internalType: "uint256", name: "_noOfVotes", type: "uint256" },
      { internalType: "bool", name: "status", type: "bool" },
      { internalType: "uint256", name: "lastactivetime", type: "uint256" },
      { internalType: "uint256", name: "daoPoints", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "time_created", type: "uint256" },
...
const daoContractAddress = "0xb4Fc66308801c17d829bcCe899D8406f2244Ac43";
...
const tokenContractAddress = "0xf4a02703f125EDC2bf1518c4398B8766ec3212Ba";
...
const treasuryContractAddress = "0xf302e9293bD9ebe5d773Cc16024E52e1D36BD548";
...
const swapContractABI = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_pairId", type: "uint256" },
      { internalType: "uint256", name: "_amount", type: "uint256" },
    ],
    name: "addLiquidity",
    outputs: [],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_token1_amount", type: "uint256" },
      { internalType: "uint256", name: "_token2Id", type: "uint256" },
      { internalType: "uint256", name: "_token2_amount", type: "uint256" },
    ],
...
const swapContractAddress = "0xE1c9De6E024e1eCC30D893f69cfe064CA481C584";
...
const nftContractAddress = "0xBD9f5936ab650715567A158eCA31Fb980Fe06182";
...
// Stake section settings
const stakeContractABI = [
  {
    inputs: [
      { internalType: "address", name: "_owner", type: "address" },
      { internalType: "address", name: "_ult", type: "address" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  ...
  {
    inputs: [{ internalType: "address", name: "_treas", type: "address" }],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "reward_accured", type: "uint256" },
...
const stakeContractAddress = "0x60EF1291e055793D7Db04B13c75B714C0Fb4b6AB";
...
const lendBorrowContractAddress = "0x12D77B8ea61863E478Aa6B766f489Af5F7a95aa7";
...
const usdtContractAddress = "0x1D5cd5833f43C63F724eBb0F28C6AaeD79bF5BF2";
const usdtContractReadSettings = new ethers.Contract(
  usdtContractAddress,
  usdtContractABI,
  scrollTestnetRPC
);
...
const daiContractAddress = "0xE9C49311b81545cCed67aB3313C8f4f938ba1920";
const daiContractReadSettings = new ethers.Contract(
  daiContractAddress,
  daiContractABI,
  scrollTestnetRPC
);
